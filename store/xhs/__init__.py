...
async def update_xhs_note(note_item: Dict):
    ...
    local_db_item = {
        ...
        "标题": note_item.get("title") or note_item.get("desc", "")[:255],  # Chinese alias for Feishu Base mapping
        ...
        "user_id": author_user_id,  # User ID
        "nickname": user_info.get("nickname"),  # User nickname
        "author_user_id": author_user_id,  # Alias for trial_notes schema
        "author_nickname": user_info.get("nickname"),  # Alias for trial_notes schema
        "author_homepage_url": f"https://www.xiaohongshu.com/user/profile/{author_user_id}" if author_user_id else "",  # Derived profile url
        ...
        "stage": "trial_notes",  # Compatible default stage for Base table
    }
...
async def update_xhs_note_comment(note_id: str, comment_item: Dict):
    ...
    local_db_item = {
        ...
        "user_id": comment_user_id,  # User ID
        "nickname": comment_user_nickname,  # User nickname
        "comment_user_id": comment_user_id,  # Alias for trial_comments schema
        "comment_user_nickname": comment_user_nickname,  # Alias for trial_comments schema
        ...
        "stage": "trial_comments",  # Compatible default stage for Base table
    }
