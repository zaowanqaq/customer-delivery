...
def convert_cookies(cookies: Optional[List[Cookie]], domain_filter: str = "") -> Tuple[str, Dict]:
    if not cookies:
        return "", {}
    # Filter by domain if specified (e.g. "xiaohongshu.com" to exclude rednote.com cookies)
    if domain_filter:
